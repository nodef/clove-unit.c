...
![Clove test run result](https://github.com/fdefelici/clove-unit/blob/master/examples/result.png)
...
If you add the path `node_modules/clove-unit.c` to your compiler's include paths.
...
## How else to Integrate

`CLove-Unit` can also be imported in your project in the following ways:
...
> Look at the [CLove101](https://github.com/fdefelici/clove-unit/blob/master/examples/clove101) project for samples about:
> - Implementing suites and tests.
> - Assertion usage ([test_suite1.c](https://github.com/fdefelici/clove-unit/blob/master/examples/clove101/src/test_suite1.c))
> - Suite setup & tear down feature ([test_suite2.c](https://github.com/fdefelici/clove-unit/blob/master/examples/clove101/src/test_suite2.c))
